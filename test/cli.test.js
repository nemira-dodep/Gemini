...
(async () => {
  ...
  assert.strictEqual(pickNextModel("flash", { fallbackModels: ["flash", "lite", "gemma", "flash-3-5"] }, { requests: { lite: 500 } }, []), "flash-3-5");
  ...
  assert.strictEqual(normalizeChatCommand("gemini --providers"), "/providers");
